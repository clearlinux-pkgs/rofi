...
Version  : 1.7.5
Release  : 4
URL      : https://github.com/davatorium/rofi/releases/download/1.7.5/rofi-1.7.5.tar.xz
Source0  : https://github.com/davatorium/rofi/releases/download/1.7.5/rofi-1.7.5.tar.xz
...
%prep
%setup -q -n rofi-1.7.5
cd %{_builddir}/rofi-1.7.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699487519
...
cp %{_builddir}/rofi-%{version}/COPYING %{buildroot}/usr/share/package-licenses/rofi/2c6d77d19eff3e3873263343c1c0d78417c64166 || :
%make_install
...
/usr/share/icons/hicolor/apps/rofi.svg
...
/usr/share/package-licenses/rofi/2c6d77d19eff3e3873263343c1c0d78417c64166
